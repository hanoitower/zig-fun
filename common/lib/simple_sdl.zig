...
pub const SimpleSdl = struct {
    ...
    pub fn createWindow(self: *SimpleSdl, title: [*:0]const u8, width: i32, height: i32) !Window {
        return Window{
            .window = c.SDL_CreateWindow(title, c.SDL_WINDOWPOS_CENTERED, c.SDL_WINDOWPOS_CENTERED, width, height, 0) orelse {
